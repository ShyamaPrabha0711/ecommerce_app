class HomeMainResponse {
  ...
  factory HomeMainResponse.fromJson(
    ...
    banner4: json["banner4"] == null
        ? []
        : List<dynamic>.from(json["banner4"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "banner4": banner4 == null
        ? []
        : List<dynamic>.from(banner4!.map((x) => x)),
    "banner5": banner5 == null
        ? []
        : List<dynamic>.from(banner5!.map((x) => x)),
...
class CategoryElement {
  ...
  CategoryElement({this.category, this.subcategory});
...
class Featuredbrand {
  ...
  Featuredbrand({this.id, this.slug, this.image, this.name, this.description});
